...
type Repository interface {
	Create(i Interval) (IntervalID, error)
	Update(i Interval) error
	ByID(id IntervalID) (Interval, error)
	Last() (Interval, error)
...
func nextCategory(r Repository) (Category, error) {
	li, err := r.Last()
	if err != nil && err == ErrNoIntervals {
...
func tick(ctx context.Context, id IntervalID, config *IntervalConfig, start, perdioic, end CallBack) error {
